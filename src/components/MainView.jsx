...
const MainView = () => {
    return (
        <div className="px-4 py-16 bg-coral-400">
            <div className="container">
                <div className="lg:flex">
                    <div className="px-6 py-10 bg-white rounded-t-3xl">
                    ...
                    <img className='w-full h-[240px] md:h-[480px] img-fit rounded-b-3xl' src={imgMain} alt="main view point image" />
                </div>
            </div>
        </div>
    );
